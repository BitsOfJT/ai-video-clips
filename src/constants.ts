...
export const IPC_CHANNELS = {
  ...
  LONGFORM_GET_EDITS: "longform:getEdits",
  LONGFORM_SAVE_EDITS: "longform:saveEdits",
  LONGFORM_EXPORT_START: "longform:export:start",
  LONGFORM_EXPORT_CANCEL: "longform:export:cancel",
  LONGFORM_EXPORT_PROGRESS: "longform:export:progress",
  LONGFORM_EXPORT_COMPLETE: "longform:export:complete",
  LONGFORM_EXPORT_ERROR: "longform:export:error",
  LONGFORM_SAVE_SRT: "longform:saveSrt",
  LONGFORM_SAVE_THUMBNAIL: "longform:saveThumbnail",
